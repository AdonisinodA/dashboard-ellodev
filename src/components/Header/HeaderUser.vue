...
import { MdSharpDarkMode , FaUser, MdRoundNotifications} from '@kalimahapps/vue-icons';
...
<template>
    <header class="flex items-center  bg-white shadow rounded-xl px-4 py-2 w-screen justify-between h-20">
      ...
      <div class="flex items-center space-x-4 pr-20 md:pr-4 ">
         ...
         <MdRoundNotifications class="text-gray-600 hover:scale-110 hover:cursor-pointer"/>
      </div>
    </header>
  </template>
